...
var chartbuilder = {
	...
	init: function(data, el, d3, noUiSlider) {
    	...
    	this.create(data, config, d3, noUiSlider)

	},

	create: function(data, config, d3, noUiSlider, setup = true) {
